...
import ru.wert.bazapik_mobile.data.servicesREST.CoatService;
import ru.wert.bazapik_mobile.data.servicesREST.DensityService;
import ru.wert.bazapik_mobile.data.servicesREST.DetailService;
...
import ru.wert.bazapik_mobile.data.servicesREST.MatTypeService;
import ru.wert.bazapik_mobile.data.servicesREST.MaterialGroupService;
import ru.wert.bazapik_mobile.data.servicesREST.MaterialService;
...
import ru.wert.bazapik_mobile.data.servicesREST.ProcessService;
import ru.wert.bazapik_mobile.data.servicesREST.ProductGroupService;
...
public class BLlinks {
    ...
    public static AnyPartTypeService partTypeService;
